...
export default function Dashboard() {
  ...
  const trust = (stats as any)?.trust ?? {};
    ...
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {statCards.map((card, i) => (
          <Card key={i} className="border-none shadow-md shadow-slate-200/50 hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              {hasSentiment ? (
                ...
                <div className="h-[160px] flex flex-col items-center justify-center text-slate-400">
                  <SmilePlus className="w-10 h-10 mb-2 text-slate-200" />
