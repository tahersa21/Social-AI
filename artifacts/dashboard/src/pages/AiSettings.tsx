  ...
  useEffect(() => {
    if (config) {
      form.reset({
        ...
        botEnabled: (config as any).botEnabled !== 0,
        botDisabledMessage: (config as any).botDisabledMessage || "",
        confidenceThreshold: parseFloat((config as any).confidenceThreshold ?? "0.5"),
        confidenceBelowAction: (config as any).confidenceBelowAction ?? "none",
        safeModeEnabled: (config as any).safeModeEnabled === 1,
        safeModeLevel: (config as any).safeModeLevel ?? "standard",
        customerMemoryEnabled: (config as any).customerMemoryEnabled === 1,
        salesBoostEnabled: (config as any).salesBoostEnabled === 1,
        salesBoostLevel: (config as any).salesBoostLevel ?? "medium",
        priceLockEnabled: (config as any).priceLockEnabled === 1,
        humanGuaranteeEnabled: (config as any).humanGuaranteeEnabled === 1,
        smartEscalationEnabled: (config as any).smartEscalationEnabled === 1,
      });
      if (config.pageLogoUrl) setLogoPreview(config.pageLogoUrl);
      if ((config as any).quickReplyButtons) {
        try {
          const parsed = JSON.parse((config as any).quickReplyButtons);
      ...
      <Form {...form}>
        <form className="space-y-6">
          ...
          <Card className={`border-2 shadow-md ${form.watch("botEnabled") ? "border-green-200 shadow-green-100/50" : "border-red-200 shadow-red-100/50"}`}>
            ...
            <CardContent className="pt-6 space-y-4">
              <FormField control={form.control} name="botEnabled" render={({ field }) => (
                <FormItem className="flex items-center justify-between rounded-xl border border-border/60 bg-slate-50/50 px-4 py-3">
                  <div>
          ...
          <Card className="border-none shadow-md shadow-slate-200/50">
            <CardHeader className="bg-slate-50/50 rounded-t-xl border-b border-border/50 pb-4">
              <CardTitle className="text-lg flex items-center gap-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <FormField control={form.control} name="confidenceBelowAction" render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <select {...field} className="h-11 w-full rounded-md border border-input bg-slate-50/50 px-3 text-sm focus:outline-none focus:ring-2 focus:ring-ring">
          ...
          <Card className="border-none shadow-md shadow-slate-200/50">
            ...
            <CardContent className="pt-6 space-y-4">
              ...
              <FormField control={form.control} name="safeModeEnabled" render={({ field }) => (
                <FormItem className="flex items-center justify-between rounded-xl border p-4 bg-slate-50/30">
                  <div>
            ...
            <CardContent className="pt-6 space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <FormField control={form.control} name="pageName" render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl><Input placeholder="مثال: متجر الأناقة" {...field} className="h-11 bg-slate-50/50" /></FormControl>
                  </FormItem>
                )} />
                <FormField control={form.control} name="pageFacebookUrl" render={({ field }) => (
                  <FormItem>
                    <FormLabel>رابط الصفحة / Facebook URL</FormLabel>
                    <FormControl><Input placeholder="https://facebook.com/yourpage" {...field} className="h-11 bg-slate-50/50" /></FormControl>
                  </FormItem>
                )} />
              </div>
              <FormField control={form.control} name="pageDescription" render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl><Textarea placeholder="وصف مختصر عن نشاط صفحتك..." {...field} className="bg-slate-50/50" /></FormControl>
                </FormItem>
              )} />
            ...
            <CardContent className="pt-6 space-y-6">
              <FormField control={form.control} name="botName" render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl><Input placeholder="مثال: المساعد الذكي" {...field} className="h-11 bg-slate-50/50" /></FormControl>
                  <FormMessage />
                </FormItem>
              )} />
              <FormField control={form.control} name="personality" render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl><Textarea placeholder="صف كيف تريد أن يتحدث البوت..." {...field} className="min-h-[100px] bg-slate-50/50" /></FormControl>
              ...
              <FormField control={form.control} name="greetingMessage" render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl><Textarea placeholder="مرحباً! كيف يمكنني مساعدتك اليوم؟" {...field} className="bg-slate-50/50" /></FormControl>
                </FormItem>
              )} />
            </CardContent>
          </Card>
            ...
            <CardContent className="pt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
              <FormField control={form.control} name="businessCountry" render={({ field }) => (
                <FormItem>
                  ...
                  <Select onValueChange={field.onChange} defaultValue={field.value}>
                    <FormControl><SelectTrigger className="h-11 bg-slate-50/50"><SelectValue placeholder="اختر البلد" /></SelectTrigger></FormControl>
                    <SelectContent>
              ...
              <FormField control={form.control} name="businessCity" render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl><Input placeholder="مثال: الجزائر العاصمة" {...field} className="h-11 bg-slate-50/50" /></FormControl>
                </FormItem>
              )} />
              <FormField control={form.control} name="businessDomain" render={({ field }) => (
                <FormItem className="md:col-span-2">
                  ...
                  <Select onValueChange={field.onChange} defaultValue={field.value}>
                    <FormControl><SelectTrigger className="h-11 bg-slate-50/50"><SelectValue placeholder="اختر المجال" /></SelectTrigger></FormControl>
                    <SelectContent>
              ...
              {currentDomain === "other" && (
                <FormField control={form.control} name="businessDomainCustom" render={({ field }) => (
                  <FormItem className="md:col-span-2">
                    ...
                    <FormControl><Input placeholder="اكتب مجالك..." {...field} className="h-11 bg-slate-50/50" /></FormControl>
                  </FormItem>
                )} />
              )}
                  ...
                  {TARGET_AUDIENCES.map(aud => {
                    ...
                    return (
                      <Badge
                        ...
                        className={`cursor-pointer px-4 py-1.5 text-sm transition-all hover-elevate ${isSelected ? 'shadow-md shadow-primary/20' : 'bg-slate-50'}`}
          ...
          <Card className="border-none shadow-md shadow-slate-200/50">
            ...
            <CardContent className="pt-6 space-y-6">
              <FormField control={form.control} name="strictTopicMode" render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-xl border border-border/50 bg-slate-50/50 p-4 shadow-sm">
              ...
              <FormField control={form.control} name="offTopicResponse" render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl><Textarea placeholder="عذراً، لا أستطيع المساعدة في هذا الموضوع..." {...field} className="bg-slate-50/50" /></FormControl>
                </FormItem>
              )} />
              <div className="space-y-3">
                <label className="text-sm font-medium">الكلمات المحظورة / Blocked Keywords</label>
                <div className="flex gap-2">
                  <Input value={keywordInput} onChange={(e) => setKeywordInput(e.target.value)} placeholder="أضف كلمة..." className="h-10 bg-slate-50/50"
              ...
              <FormField control={form.control} name="maxOffTopicMessages" render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl><Input type="number" value={field.value} onChange={(e) => field.onChange(parseInt(e.target.value) || 3)} className="h-11 bg-slate-50/50 max-w-xs" min={1} /></FormControl>
                </FormItem>
              )} />
            </CardContent>
          </Card>
            ...
            <CardContent className="pt-6 space-y-6">
              <FormField control={form.control} name="handoffKeyword" render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl><Input placeholder="مثال: بشري" {...field} className="h-11 bg-slate-50/50 max-w-xs" /></FormControl>
              ...
              <FormField control={form.control} name="handoffMessage" render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl><Textarea placeholder="تم تحويلك إلى فريق الدعم..." {...field} className="bg-slate-50/50" /></FormControl>
                </FormItem>
              )} />
            </CardContent>
          </Card>
            ...
            <CardContent className="pt-6 space-y-6">
              ...
              <div className={`grid grid-cols-1 md:grid-cols-2 gap-6 transition-opacity ${!form.watch("workingHoursEnabled") ? "opacity-40 pointer-events-none" : ""}`}>
                <FormField control={form.control} name="businessHoursStart" render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl><Input type="time" {...field} className="h-11 bg-slate-50/50" /></FormControl>
                  </FormItem>
                )} />
                ...
                <FormField control={form.control} name="outsideHoursMessage" render={({ field }) => (
                  <FormItem className="md:col-span-2">
                    ...
                    <FormControl><Textarea placeholder="عذراً، نحن خارج أوقات العمل حالياً..." {...field} className="bg-slate-50/50" /></FormControl>
                  </FormItem>
                )} />
              </div>
              <FormField control={form.control} name="currency" render={({ field }) => (
                <FormItem>
                  ...
                  <Select onValueChange={field.onChange} defaultValue={field.value}>
                    <FormControl><SelectTrigger className="h-11 bg-slate-50/50 max-w-xs"><SelectValue placeholder="اختر العملة" /></SelectTrigger></FormControl>
                    <SelectContent>
          ...
          <Card className="border-none shadow-md shadow-slate-200/50">
            ...
            <CardContent className="pt-6 space-y-6">
                ...
                <>
                              ...
                              <button
                                ...
                                className={`flex items-center gap-2 px-4 py-2.5 rounded-xl border text-sm font-medium transition-all ${
                                  checked
                                    ...
                                    : "bg-slate-50 border-border hover:border-primary/40"
                                }`}
                              >
                                <span>{opt.icon}</span>
                                <span>{opt.label}</span>
                  ...
                  <FormField control={form.control} name="leadCaptureMessage" render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl><Textarea placeholder="لمتابعتك والرد على استفسارك، هل يمكنك مشاركة رقم هاتفك؟" {...field} className="bg-slate-50/50" /></FormControl>
              ...
              {form.watch("useQuickReplies") && (
                <div className="rounded-xl border border-border/50 bg-slate-50/50 p-4 space-y-4">
                  ...
                  <div className="space-y-2">
                    {qrButtons.map((btn, idx) => (
                      <div key={idx} className="flex items-center gap-2 bg-white rounded-lg border border-border/50 p-2.5 shadow-sm">
                        <div className="flex-1 grid grid-cols-2 gap-2">
                          <input
                            ...
                            className="text-sm border border-border/50 rounded-lg px-3 py-1.5 bg-slate-50 focus:outline-none focus:ring-2 focus:ring-primary/20"
                          />
                          <select
                            value={btn.payload}
                            onChange={(e) => {
                  ...
                  {qrButtons.length < 13 && (
                    <div className="flex items-center gap-2 pt-1">
                      <input
                        ...
                        className="flex-1 text-sm border border-border/50 rounded-lg px-3 py-2 bg-white focus:outline-none focus:ring-2 focus:ring-primary/20"
                      />
                      <select
                        value={newQrPayload}
                        onChange={(e) => setNewQrPayload(e.target.value)}
                        className="text-sm border border-border/50 rounded-lg px-3 py-2 bg-white focus:outline-none focus:ring-2 focus:ring-primary/20"
                      >
            ...
            <CardContent className="pt-6 space-y-6">
                ...
                <>
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          ...
                          className="h-11 bg-slate-50/50 max-w-xs"
                        />
                      </FormControl>
                  ...
                  <FormField control={form.control} name="abandonedCartMessage" render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        المتغيرات المتاحة: <code className="bg-slate-100 px-1 rounded">{"{product_name}"}</code> اسم المنتج، <code className="bg-slate-100 px-1 rounded">{"{page_name}"}</code> اسم الصفحة
                      </FormDescription>
                    </FormItem>
                  )} />
                </>
              ...
              {cartStats && (
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4 border-t border-border/50">
                  <div className="p-4 rounded-xl bg-slate-50/50 border border-border/50 text-center">
