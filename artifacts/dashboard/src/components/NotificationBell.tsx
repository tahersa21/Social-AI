    ...
    <div className="relative" ref={dropdownRef}>
      ...
      {open && (
        <div className="absolute left-0 md:right-0 md:left-auto top-full mt-2 w-80 bg-card border border-border rounded-xl shadow-xl z-50 overflow-hidden">
          <div className="flex items-center justify-between px-4 py-3 border-b border-border/50 bg-slate-50/80">
              ...
              notifications.map(notif => {
                ...
                return (
                  <button
                    ...
                    className="w-full flex items-start gap-3 px-4 py-3 hover:bg-slate-50 transition-colors text-right border-b border-border/30 last:border-0"
                  >
